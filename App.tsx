...
import DeviceInfoVc from './Components/InfoVc';
import InfoVc from './Components/InfoVc';
import RTCheck from './Components/RTCheck';
...
function MyStack() {
  return (
    <Stack.Navigator>
      ...
      <Stack.Screen name = "rtccheck" component={RTCheck}/>
